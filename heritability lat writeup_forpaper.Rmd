...
if(readprocessed==0) {
  ...
  oldnewLIcor <-
  cor(temp$peakLI, temp$lat_index, use = 'pairwise.complete.obs')
  oldnewLIcorDF <- nrow(temp) - 2
  
  #check split half reliablity
  splithalfr <-
  cor(temp$my_li_mean_even, temp$my_li_mean_odd, use = 'pairwise.complete.obs')
  #--------------------------------------------------------------------------------------
}
```
