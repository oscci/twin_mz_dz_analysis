...
#L and R flow are highly correlated: rather than a difference score, try LI as a residual
mylm3 <- summary(lm(doubledata$mean_left_flow ~ doubledata$mean_right_flow))
doubledata$LIresid<-doubledata$mean_left_flow -(mylm3$coefficients[1,1]+
    mylm3$coefficients[2,1]*doubledata$mean_right_flow)
doubledata$LIresid2<-doubledata$mean_left_flow2 -(mylm3$coefficients[1,1]+                    mylm3$coefficients[2,1]*doubledata$mean_right_flow2)
...
mycols<-c("ehp_handedness", "qhp_handedness", "lat_index","peakLI","peakcatbinary","Lflow.resid","Rflow.resid","LIresid")
mycolnames<-c("Edinburgh Handedness Inventory","Quantification of Hand Preference","Laterality index (fTCD)","Laterality index (peak FTCD)", "Binary typical (1)/atypical (0)","Mean flow L","Mean flow R","LI as residual")
